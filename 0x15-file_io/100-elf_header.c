...
/**
 * c_elf - Checks for an ELF file
 * @e_ident: Pointer to array with magic number
 */
void c_elf(unsigned char *e_ident)
{
	int idx;
...
/**
 * p_magic - Prints magic num of ELF header
 * @e_ident: Pointer to array with magic nums
 */
void p_magic(unsigned char *e_ident)
{
	int idx;
...
/**
 * p_version - Prints version of ELF header
...
/**
 * p_osabi - Prints OS/ABI of ELF header
 * @e_ident: Pointer to array with ELF OS/ABI
 */
void p_osabi(unsigned char *e_ident)
{
	printf(" OS/ABI                ");
